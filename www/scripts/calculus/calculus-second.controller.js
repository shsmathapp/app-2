(function() {
	...
	angular
		...
		.controller('CalculusSecondController', CalculusSecondController);

	CalculusSecondController.$inject = [
		'$stateParams', '$ionicActionSheet', '$cordovaSocialSharing', 'calculusService'];

	/* @ngInject */
	function CalculusSecondController($stateParams, $ionicActionSheet, $cordovaSocialSharing, calculusService) {
		...
		function loadArticle() {
			calculusService.getArticle(articleId)
